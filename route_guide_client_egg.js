...
var routeguide = grpc.loadPackageDefinition(packageDefinition).egg.common;
// var r1 = fs.readFileSync('../route_guide/zuzuche.net.key');
// var r2 = fs.readFileSync('../route_guide/zuzuche.net.pem');
// console.log(r1);
// var client = new routeguide.Main('taxi-mixer-server-api-dev.ttmap-devx.zuzuche.net',
//                                        grpc.credentials.createSsl(null, r1, r2));
// var client = new routeguide.Main('taxi-mixer-server-api-dev.ttmap-devx.zuzuche.net:80',
//                                        grpc.credentials.createInsecure());
var client = new routeguide.Main('localhost:80',
                                       grpc.credentials.createInsecure());



//  client = new routeguide.RouteGuide('loc                                      grpc.credentials.createInsecure());
...
function echo() {
  console.log('zzzzzzzzzzzzzzzzz', client);
...
function test() {
  ...
  call.write({
    ...
    parameter: JSON.stringify({
      business: "estimatePrice",
      carType: "2,3",
      city: "0571",
      clid: "1",
      slat:30.206937,
      slng: 120.221211,
      supplierCodes: ["caocao"],
      elat: 30.290349,
      elng: 120.215889,
      token: "q333"
    })
